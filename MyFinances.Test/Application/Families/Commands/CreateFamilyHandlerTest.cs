...
public class CreateFamilyHandlerTest
{
    ...
    public async Task ShouldCreateFamily()
    {
        ...
        _familyRepositoryMock
            ...
            .Callback<Family, CancellationToken>((family, token) => fakeFamily = family)
        ...
        // Assert
        _familyRepositoryMock.Verify(repo => repo.AddAsync(It.IsAny<Domain.Entities.Family>(), It.IsAny<CancellationToken>()), Times.Once);
